...
<ul id="header_links">
	<!--<li id="header_link_contact"><a href="{$link->getPageLink('contact', true)|escape:'html'}" title="{l s='contact' mod='blockpermanentlinks'}">{l s='Contacto' mod='blockpermanentlinks'}</a></li> !-->
