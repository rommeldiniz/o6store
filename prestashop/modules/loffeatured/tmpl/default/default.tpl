	...
	<section class="featured-widget">
		<header>
        		<h3 class="featured-title">{l s='LO ULTIMO TOP' mod='loffeatured'}
                	<hr style="width:550px; position:absolute; margin-left:120px;" class="art"/>
                	<hr style="width:550px; position:absolute; margin-left:120px; margin-top:-7px !important;" class="art"/>
                </h3>
