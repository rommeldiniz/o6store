...
<div id="header_user" {if $PS_CATALOG_MODE}class="header_user_catalog"{/if}>
	...
	<p id="header_user_info">
		...
		{if $logged}
			...
			<a href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html'}" title="{l s='Logout' mod='blockuserinfo'}" class="logout" rel="nofollow">{l s='Log out' mod='blockuserinfo'}</a>
		{else}
		...
		{/if}
			<a href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Contactanos' mod='blockuserinfo'}" class="login" rel="nofollow">{l s='Contacto' mod='blockuserinfo'}</a>
	</p>
</div>
<!-- /Block user information module HEADER -->
